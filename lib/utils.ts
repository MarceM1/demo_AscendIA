...
import { Archive,Activity, ArrowBigUpDash, FileUser, AudioWaveform, AudioLines, ChartNoAxesColumn, GraduationCap, LucideFocus, Shovel, List, Home, PlusCircle, Plus, Newspaper, FileArchive, Send, Coins  } from 'lucide-react'
